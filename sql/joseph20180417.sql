...
-- ----------------------------
-- Table structure for match_histroy
-- ----------------------------
DROP TABLE IF EXISTS `match_histroy`;
CREATE TABLE `match_histroy` (
  `id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '2121', '', '13726271207', '1', '1992-02-29 00:00:00', '0', 'php', '互联网', '珠海', '珠海，澳门', '<p>dsadsadsa</p>', '傻', '0', '2018-04-10 14:44:11', null, '2018-04-17 15:44:31', null, '1', null);
